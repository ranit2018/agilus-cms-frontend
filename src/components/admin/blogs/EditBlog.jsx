...
class EditBlog extends Component {
  ...
  render() {
    const { blogDetails } = this.props.location.state;
    ...
    const newInitialValues = {
      featured_image: "",
      title: htmlDecode(blogDetails.title),
      content: htmlDecode(blogDetails.content),
      permalink: htmlDecode(blogDetails.permalink),
      category_id: this.props.location.state.selectedCategoryList.map((i) => {
        return i.value;
      }),
      keywords: blogDetails.keywords.split(","),
      status: blogDetails.status,
      blog_subtext: htmlDecode(blogDetails.blog_subtext),
      meta_title: htmlDecode(blogDetails.meta_title),
      meta_description: htmlDecode(blogDetails.meta_description),
      author_name: htmlDecode(blogDetails.author_name),
      author_bio: htmlDecode(blogDetails.author_bio),
    };
