...
class EditKeyMembers extends Component {
    ...
    handleSubmitEvent = (values, actions) => {
        ...
        API.put(`/api/feed/page_details/17`, { content: values.content, status: '1' })
            .then(res => {
                this.setState({ showModal: false })
                swal({
                    closeOnClickOutside: false,
                    title: "Success",
                    text: "Key Members Updated Successfully",
                    icon: "success"
                }).then(() => {
