...
class EditCovidAntibody extends Component {
    ...
    handleSubmitEvent = (values, actions) => {
        ...
        API.put(`/api/feed/page_details/13`, { content: values.content, status: '1' })
            .then(res => {
                this.setState({ showModal: false })
                swal({
                    closeOnClickOutside: false,
                    title: "Success",
                    text: "Convid Antibody Updated Successfully",
                    icon: "success"
                }).then(() => {
                    this.props.history.push('/pages/covidantibody')
                });
            })
            .catch(err => {
...
export default EditCovidAntibody