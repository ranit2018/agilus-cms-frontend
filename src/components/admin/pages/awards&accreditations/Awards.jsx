...
class Awards extends Component {
    ...
    getDisclaimer = () => {
        API.get(`/api/feed/page_details/18`)
        .then((res) => {
          this.setState({
                    ...
                    <div className="">
                      <button
                        ...
                        onClick={(e) => this.props.history.push({
                            pathname: '/about-us/edit-awards-accreditation/'+this.state.disclaimerId,
                            state: { content: this.state.disclaimer}
                        })}
                      >
                        <i className="fas fa-plus m-r-5" /> Edit Awards & Accreditations
                        </button>
                    </div>
                  </div>
                </div>
