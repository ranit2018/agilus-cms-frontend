...
class EditAwards extends Component {
    ...
    handleSubmitEvent = (values, actions) => {
        ...
        API.put(`/api/feed/page_details/18`, { content: values.content, status: '1' })
            .then(res => {
                this.setState({ showModal: false })
                swal({
                    closeOnClickOutside: false,
                    title: "Success",
                    text: " Awards & Accreditations Updated Successfully",
                    icon: "success"
                }).then(() => {
                    this.props.history.push('/about-us/awards-accreditation')
                });
            })
            .catch(err => {
