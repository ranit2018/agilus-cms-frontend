...
class EditPrivacyPolicy extends Component {
    ...
    handleSubmitEvent = (values, actions) => {
        ...
        API.put(`/api/feed/page_details/3`, { content: values.content, status: '1' })
            .then(res => {
                this.setState({ showModal: false })
                swal({
                    closeOnClickOutside: false,
                    title: "Success",
                    text: "Privacy and Policy Updated Successfully",
                    icon: "success"
                }).then(() => {
                    this.props.history.push('/pages/privacy-policy')
                });
            })
            .catch(err => {
