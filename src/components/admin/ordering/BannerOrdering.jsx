...
class BannerOrdering extends Component {
    constructor(props) {
        super(props)
    ...
    getOrderingList = () => {
        ...
        API.get(
            ...
            .then((res) => {
                this.setState({
                    list: spliceIntoChunks(res.data.data, 3),
                    isLoading: false,
                });
            })
            .catch((err) => {
    ...
    handleOnDragEnd = (result) => {
        ...
        const items = reorderData(this.state.list, result.source, result.destination, 3);
        this.setState({
            list: items,
        })
    }
