...
class CodeofConductOrdering extends Component {
    constructor(props) {
        super(props)
    ...
    getOrderingList = () => {
        ...
        API.get(
            ...
            .then((res) => {
                this.setState({
                    list: spliceIntoChunks(res.data.data, 6),
                    isLoading: false,
                });
            })
            .catch((err) => {
    ...
    handleOnDragEnd = (result) => {
        ...
        const items = reorderData(this.state.list, result.source, result.destination, 6);
        this.setState({
            list: items,
        })
    }
                    ...
                    <section className="content-header">
                        <div className="row">
                            <div className="col-lg-12 col-sm-12 col-xs-12">
                                <h1>
                                Manage Code of Conduct Ordering
                                    <small />
                                </h1>
                            </div>
                                                                    ...
                                                                    >
                                                                        {(provided) => (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div
                                                                                    className="drag-box blue"
                                                                                   
                                                                                >
                                                                                    <img
                                                                                        src={val.code_of_conduct_image}
                                                                                        alt="Image"
                                                                                        height="100px"
                                                                                        width="100%"
                                                                                    />
...
export default CodeofConductOrdering
