...
export default class LifeAtSrl extends Component {
  ...
  getCategorydetails(id) {
    API.get(`/api/home/benefits/${Number(id)}`)
      .then((res) => {
        this.setState({
          showModal: true,
  ...
  chageStatus = (cell, status) => {
    API.put(`/api/home/benefits/change_status/${cell}`, {
  ...
  setHealthBenefitImage = (refObj) => (cell, row) => {
    if (row.benefits_file !== null) {
      return (
        <>
          <img
            src={row.benefits_file}
  ...
  handleSubmitEvent = async (values, actions) => {
    ...
    formData.append("benefits_file", this.state.inside_srl_file);

    if (this.state.categoryId > 0) {
      url = `/api/home/benefits/${this.state.categoryId}`;
      method = "PUT";
    } else {
      url = `/api/home/benefits`;
      method = "POST";
    }
            ...
            <div className="row">
              ...
              <div className="col-lg-12 col-sm-12 col-xs-12  topSearchSection">
                <div className="">
                  ...
                  >
                    <i className="fas fa-plus m-r-5" /> Add Benefits at Srl
                  </button>
                </div>
