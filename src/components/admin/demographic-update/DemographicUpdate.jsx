                ...
                if(key == 'Prescription'){
                    ...
                    ret.push(
                        <Row>
                            ...
                            <Col xs={6} sm={6} md={6}>
                                <a target="_blank" href={element} >Download</a>
                            </Col>
                        </Row>
                    );
                }
                                ...
                                <form>
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="3">Covid19 Enquiry</option>
                                            <option value="7">Become A Partner</option>
                                            <option value="8">Become A Vendor</option>
