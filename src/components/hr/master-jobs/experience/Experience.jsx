...
class JobCategories extends Component {
  ...
  getcategoryDetails(id) {
    API.get(`api/job_portal/experience/${id}`)
      .then((res) => {
        this.setState({
            ...
            <div className="row">
              ...
              <div className="col-lg-12 col-sm-12 col-xs-12  topSearchSection">
                <div className="">
                  ...
                  >
                    <i className="fas fa-plus m-r-5" /> Add Job Experience
                  </button>
                </div>
                <form className="form">
                  <div className="">
                    <input
                      ...
                      placeholder="Filter by Job Experience"
                    />
                  </div>
                      ...
                      return (
                        <Form>
                          <Modal.Header closeButton>
                            <Modal.Title>
                              {this.state.categoryId == 0 ? 'Add' : 'Edit'} Job
                              Category
                            </Modal.Title>
                          </Modal.Header>
                          <Modal.Body>
