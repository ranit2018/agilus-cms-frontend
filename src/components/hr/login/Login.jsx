...
import { hrLogin } from "../../../store/actions/auth";
import { isHRCheck } from "../../../shared/helper";
...
class Login extends Component {
  ...
  render() {
    ...
    if (token) {
      if(isHRCheck(token)){
          console.log('login',isHRCheck(token))
              ...
              return (
                <Form>
                  ...
                  <div className="login-box-body">
                    <p className="login-box-msg">HR Login to Your Account</p>
...
const mapDispatchToProps = (dispatch) => {
  return {
    submitLogin: (data, onSuccess, setErrors) =>
      dispatch(hrLogin(data, onSuccess, setErrors)),
  };
};
